                ...
                <div class="card card-profile">
                    ...
                    <div class="card-body pt-0">
                            ...
                            <div class="col">
                                <div class="d-flex justify-content-center">
                                    <div class="d-grid text-center">
                                        ...
                                        <span class="text-sm opacity-8">Sertificate</span>
                                    </div>
                                    ...
                                    <div class="d-grid text-center">
                                        <span class="text-lg font-weight-bolder">2 Years</span>
                        ...
                        <div class="text-center mt-4">
                            <h5>
                                I Nyoman Ray<span class="font-weight-light">, 20.yo</span>
                            </h5>
                            <div class="h6 font-weight-300">
                                <i class="ni location_pin mr-2"></i>Condongcatur, Yogyakarta
                            </div>
                            <div class="h6 mt-4">
